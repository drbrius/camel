import { TradeCalculationInput, TradeCalculationResult, CamelBreed, TradeItemCategory } from '../types';
...
export const CAMEL_BREEDS: CamelBreed[] = [
  ...
  },
  {
    ...
    description: 'The ancient two-humped heavy-duty cold-climate titan. Features an ultra-plush rugged wool coat, twin fat repositories, and phenomenal cargo-bearing capabilities.',
    rarity: 'Rare'
  },
  {
    id: 'wild_bactrian',
